...
#import "Model_Answer.h"
@interface Model_Item : Model_ObjectBase<NSCopying>
{
    NSString* Id; 
    NSString* Identity; 
    NSString* Title; 
    ...
    Model_Media* ItemMedia;
    Model_Media* ItemPhoto;
    Model_Answer* ItemAnswer;
    
    NSMutableArray* aItems;
    NSMutableArray* cItems;
}
@property(strong,nonatomic)NSMutableArray* cItems;
@property(strong,nonatomic)NSMutableArray* aItems;
@property(strong,nonatomic)Model_Answer* ItemAnswer;
@property(strong,nonatomic)Model_Media* ItemPhoto;
@property(strong,nonatomic)Model_Media* ItemMedia;
...
- (id)initWithXml:(DDXMLElement *)node surveyLib:(SurveyLibraryLiteral*) surveyLib type:(int)type;
@end
