...
@interface UnitrueDialog : UIView {
...
@protocol UnitrueDialogDelegate<NSObject>

@optional
- (void)UnitrueDialogDidCancel:(UnitrueDialog *)dialog;
- (void)UnitrueDialogDidReturn:(UnitrueDialog *)dialog
